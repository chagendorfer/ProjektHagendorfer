CREATE DATABASE  IF NOT EXISTS `projektdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `projektdb`;
...
CREATE TABLE `befund` (
  ...
  CONSTRAINT `befund_ibfk_1` FOREIGN KEY (`PatientID`) REFERENCES `patient` (`PatientID`)
...
CREATE TABLE `patient` (
  ...
  KEY `BundeslandID` (`BundeslandID`),
  KEY `GeschlechtID` (`GeschlechtID`),
  KEY `KrankenkasseID` (`KrankenkasseID`),
  CONSTRAINT `patient_ibfk_1` FOREIGN KEY (`BundeslandID`) REFERENCES `bundesland` (`BundeslandID`),
  CONSTRAINT `patient_ibfk_2` FOREIGN KEY (`GeschlechtID`) REFERENCES `geschlecht` (`GeschlechtID`),
  CONSTRAINT `patient_ibfk_3` FOREIGN KEY (`KrankenkasseID`) REFERENCES `krankenkasse` (`KrankenkasseID`)
...
-- Dump completed on 2025-01-28 22:46:44
